...
export default function Bio() {
  return (
    <div className="flex relative text-center md:text-left xl:flex-row xl:px-10 min-h-screen justify-center xl:max-w-[800px] md:max-w-[600px] sm:max-w-[500px] mx-auto items-center snap-center overflow-scroll">
