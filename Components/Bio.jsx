...
export default function Bio() {
  return (
    <div className="flex relative flex-col text-center md:text-left xl:flex-row  xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center snap-center">
      ...
      <div className="flex absolute flex-row text-center text-gray-300 text-lg top-56 sm:min-w-[300px] xl:flex-row max-w-[800px] items-center snap-center">
        <p className="flex relative bottom-5 text-base">
          {
