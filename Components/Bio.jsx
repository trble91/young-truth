...
export default function Bio() {
  return (
    <div className="flex relative flex-col text-center md:text-left xl:flex-row  xl:px-10 min-h-screen justify-center xl:max-w-[800px] md:max-w-[600px] sm:max-w-[500px] xl:space-y-0 mx-auto items-center snap-center">
      <h3 className="absolute top-20 uppercase tracking-[20px] text-gray-300 text-2xl sm:text-gray-300 snap-center">
        Bio
      </h3>
      <div className="flex absolute flex-row text-center text-gray-300 top-40 xl:flex-row xl:max-w-[800px] md:max-w-[600px] sm:max-w-[300px] items-center snap-center">
        <p className="flex relative bottom-5 sm:text-sm md:text-sm xl:text-base">
          {
