...
export default function Bio() {
  return (
    <div className="flex relative flex-col text-center md:text-left xl:flex-row  xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center snap-center">
      <h3 className="absolute top-40 uppercase tracking-[20px] text-gray-300 text-2xl sm:text-gray-300 snap-center">
        Bio
      </h3>
      <div className="flex absolute flex-row text-center text-gray-300 top-56 xl:flex-row xl:max-w-[800px] md:max-w-[600px] sm:max-w-[500px] items-center snap-center">
